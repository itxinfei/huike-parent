...
public class TbRulePool extends BaseEntity {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("id", getId()).append("limitTime", getLimitTime()).append("limitTimeType", getLimitTimeType()).append("warnTime", getWarnTime()).append("warnTimeType", getWarnTimeType()).append("repeatGetTime", getRepeatGetTime()).append("repeatType", getRepeatType()).append("maxNunmber", getMaxNunmber()).append("type", getType()).toString();
    }
